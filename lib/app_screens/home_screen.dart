...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final List<Widget> _pages = const [_HomeTab(), LearningTab(), FeedbackFormTab()];
...
// class _HomeScreenState extends State<HomeScreen> {
//   int _selectedIndex = 0;
//   final List<Widget> _pages = const [_HomeTab(), _ProfileTab(), LearningTab()];
//
//   void _onNavTap(int index) => setState(() => _selectedIndex = index);
//
//   @override
